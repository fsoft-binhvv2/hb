<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
            	<form id="form_list" method="post" action="<?=$this->index_url;?>admin/scholarship">
                <input type="hidden" id="act" name="act" value="act_del" />
                	<table class="list">
                    	<thead>
                        	<tr>
                            	<td width="1" style="text-align:center;"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></td>
                                <td class="left"><a href="#">Tên học bổng</a></td>
                                <td class="left"><a href="#">Trường</a></td>
                                 <td class="left"><a href="#">Logo</a></td>
                                 <td class="left"><a href="#">Deadline</a></td>
                                  <td class="left"><a href="#">Link gốc</a></td>
				...
				<?php foreach($lists as $user) : ?>
                            <tr>
                                ...
                                <td class="left"><?=$user['university_name'];?></td>
                                 <td class="left"><img src="<?=base_url();?><?=$user['image'];?>" width="50" height="50" style="padding:2px; border:1px solid #cccccc;"/></td>
                                 <td class="left"><?=$user['deadline'];?></td>
                                 <td class="left"><?=$user['link'];?></td>
                                <td class="right"><?=$user['order'];?></td>	
                                <td class="right">
