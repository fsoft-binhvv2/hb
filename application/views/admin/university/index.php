<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
            	<form id="form_list" method="post" action="<?=$this->index_url;?>admin/university">
                <input type="hidden" id="act" name="act" value="act_del" />
                	<table class="list">
                    	<thead>
                        	<tr>
                            	<td width="1" style="text-align:center;"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></td>
                                <td class="left"><a href="#">Tên trường</a></td>								
                                <td class="left"><a href="#">Quốc gia</a></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="left"><?php
                                    ...
                                    $sql="select name,id from country where id=\"".$id_country."\"";
