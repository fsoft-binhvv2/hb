<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
                <form id="form_list" method="post" action="<?= base_url(); ?>admin/danhmucdichvu/home">
                	...
                	<table class="list">
                    	<thead>
                        	<tr>
                                ...
                                <td class="right"><a href="#">Tính phí</a></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="left"><?=$user['content'];?></td>
                                 <td class="left">
                                 <img src="<? echo base_url();?><?=$user['images'];?>" width="50" height="50" />
                                 </td>
                                  <td class="left"><?=$user['ord'];?></td>
                                   <td class="left"><?if($user['active']==1) echo "Có tính phí"; else echo "Không tính phí";?></td>
                                <td class="right">
