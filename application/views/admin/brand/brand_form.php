    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons">
                ...
                <a href="javascript:void(0);" onclick="location.href = '<?= $this->index_url; ?>admin/brand';" class="button">Cancel</a>
            </div>
        </div><!--End heading-->
        <div class="content">
            <div id="tabs" class="htabs">
                <a href="#tab_1" class="selected">Thông tin nghành học</a>
            ...
            <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="frm_add">
                <div id="tab_1" style="display:block;">
                    <table width="100%" class="form">
                        <tbody>
                            <tr>
                                <td width="169" align="left"><label>Tên nghành học:</label></td>
                                <td width="922">
                                    <?php if (@$article->name != '') : ?>
