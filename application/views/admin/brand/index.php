<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
            	<form id="form_list" method="post" action="<?=$this->index_url;?>admin/brand">
                <input type="hidden" id="act" name="act" value="act_del" />
                	<table class="list">
                    	<thead>
                        	<tr>
                            	<td width="1" style="text-align:center;"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></td>
                                <td class="left"><a href="#">Tên nghành học</a></td>								
                                <td class="left"><a href="#">Trường học</a></td>
				...
				<?php foreach($lists as $user) : ?>
                            ...
                            <tr>
                                ...
                                <td class="left"><?php
                                    ...
                                    $sql="select name,id from university where id=\"".$id_university."\"";
