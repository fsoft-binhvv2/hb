...
class brand_model extends CI_Model {
    ...
    function add($data) {
        ...
        $this->db->set('id_university', $data['id_university']);
    ...
    function get_root_brand($parent) {
    ...
    function get_brand_where($where = null, $order = null, $limit = null) {
    ...
    function get_all($root) {
        ...
        $q = $this->db->query("SELECT * FROM brand WHERE parent = " . $root);
    ...
    function getPath($id) {
        ...
        $brand = $query->row();
        if ($brand->parent) {
            return $this->getPath($brand->parent) . '&nbsp;>&nbsp;' . $brand->brand_name;
        } else {
